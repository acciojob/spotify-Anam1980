...
public class SpotifyController {
    ...
    public String createSong(@PathVariable String title, @PathVariable String albumName, int length) throws Exception{
    ...
    public String createPlaylistOnLength(@PathVariable String mobile, @PathVariable String title, int length) throws Exception{
